/***************************************************************************
  ...
  These sensors use I2C or SPI1 to communicate, 2 or 4 pins are required
  to interface.
...
/**************************************************************************/
/*!
    @brief  Writes an 8 bit value over I2C/SPI1
*/
/**************************************************************************/
void Adafruit_BME280::write8(byte reg, byte value)
{
  if (_cs == -1) {
    ...
    if (_sck == -1) {
      SPI1.end();
      // SPI1.endTransaction();              // release the SPI1 bus
    }
  }
}
